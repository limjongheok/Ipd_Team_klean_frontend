    ...
    return(
        <div className="MainHeader">
            <Grid container id="MainHeaderGridContainer">
                ...
                <Grid item xs={4} sm={9} id= "MainHeaderGrid2"></Grid>
                <Grid item xs={6} sm={2} id= "MainHeaderGrid3">
                    <Grid container id="MainHeaderGG">
                        <Grid item xs={7} sm={6} id="MainHeaderGG1"><div className="MainHeaderGrid2div"><button onClick={signout} className="LogoutButton">로그아웃</button><p className="change">언어변경</p></div></Grid>
